...
name: spark
version: 0.1.2
description: "Use when the user wants to brainstorm an idea or design a feature/spec. Explores intent and requirements through dialogue, then writes a spec document to contexts/thought_review/ and STOPS. Does not auto-chain to implementation planning or any other skill. Do NOT use for: deciding whether an idea is worth building at all (use office-hours first)."
---
...
6. **Write design doc** — save to `contexts/thought_review/YYYY-MM-DD-<topic>-design.md` and commit
...
- Write the validated design (spec) to `contexts/thought_review/YYYY-MM-DD-<topic>-design.md`
