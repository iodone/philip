---
name: bestpractice-ai-debugging-diagnosis
description: AI 辅助开发中遇到“代码改不好”时的诊断思路与决策树
---
...
- 配合 `bestpractice-ai-programming-mindset` 的"70% 问题"诊断
- 配合 `bestpractice-staged-approach` 的验证机制
