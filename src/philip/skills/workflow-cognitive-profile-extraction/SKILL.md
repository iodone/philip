...
- **依赖**: [并行 Subagent 工作流](../workflow-parallel-subagents/SKILL.md)、[深度调研工作流](../workflow-deep-research-survey/SKILL.md)
- **创建日期**: 2026-03-13
...
Sub-agent 调度遵循 [并行 Subagent 工作流](../workflow-parallel-subagents/SKILL.md) 的规则：并行度 ≤5，调研 overlap 30-50%，`run_in_background=true`。
...
- [语义搜索技能](../tool-semantic-search/SKILL.md) — 超越关键词匹配，用 embedding 相似度发现语义相关的消息
- [并行 Subagent 工作流](../workflow-parallel-subagents/SKILL.md) — Sub-agent 调度的执行规则
- [深度调研工作流](../workflow-deep-research-survey/SKILL.md) — 多 agent 并行 + 交叉验证的基础架构
- [多 Agent 并行分析](../bestpractice-multi-agent-analysis/SKILL.md) — 50% overlap、交叉验证方法论
